...
const Primary = ({ to, children }) => {
  ...
  return (
    <Link
      to={to}
      className="relative inline-block pr-24 bg-green-400 bg-opacity-90 group-hover:bg-opacity-100 group-focus:bg-opacity-100 mb-1 overflow-hidden transition duration-200"
    >
